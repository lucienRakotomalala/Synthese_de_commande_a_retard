...
\textsc{\Large \bf Analyse et commande des systèmes temps réel }\\[0.5cm]

% Title
\HRule \\[0.4cm]

{\huge \bfseries  - Synthèse d'une commande à retard -\\ \textsc{Application à un procédé électro-mécanique}}
...
\emph{Encadrant:} \\
\textbf{ Carolina \textsc{Albea-Sànchez}}
\end{flushright}
\end{minipage}
\newline
\newline
